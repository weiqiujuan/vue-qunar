  ...
  <div class="list">
    <div class="list-item">
      ...
      <div class="item-wrapper">
        <div class="item" v-for="item in hotCities"
             :key="item.id" @click="handleCityChange(item.name)"
        >{{item.name}}
        </div>
      </div>
    </div>
    ...
    <div class="list-item city" v-for="(item,index) in cities"
         :key="index" :ref="'alpha-'+index"
    >
      <div class="title">{{index}}</div>
      <div class="item-wrapper">
        <div class="item" v-for="city in item" :key="city.id"
             @click="handleCityChange(city.name)">{{city.name}}
        </div>
        <div class="bt"></div>
      </div>
    </div>
